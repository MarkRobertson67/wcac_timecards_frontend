      ...
      const createdEntriesPromises = missingDates.map(async (date) => {
        ...
        try {
          ...
          return {
            ...
            facilityTotalHours: typeof savedEntry.data.facility_total_hours === 'string' ? savedEntry.data.facility_total_hours : '0h 0m',
            ...
            drivingTotalHours: typeof savedEntry.data.driving_total_hours === 'string' ? savedEntry.data.driving_total_hours : '0h 0m',
  ...
  const calculateTotalTimeForAllEntries = () => {
    ...
    timeCard.entries.forEach((entry) => {
      ...
      if (typeof entry.facilityTotalHours === 'string') {
        ...
        console.warn('facilityTotalHours is not a string:', entry.facilityTotalHours);
      }
      ...
      if (typeof entry.drivingTotalHours === 'string') {
        ...
        console.warn('drivingTotalHours is not a string:', entry.drivingTotalHours);
      }
    });
